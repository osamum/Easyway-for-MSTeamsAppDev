...
4. \</body\> タグの前のコメント「\<!-- ここに演習 2 のタスク 3 でタグを追加--\>」を以下のタグで置き換えます。
    ...
    ```
5. 以前のタスクで Microsoft Teams に追加されたタグをそれぞれ以下の方法で削除します。
    ...
    *   **チーム タブ**
        ...
        4. チャネルにインストールされているアプリの一覧が表示されるので **MyTeamTab** の行の右端にあるごみ箱のアイコンをクリックします。
...
5. タブの中に \[タスクモジュールを表示\] ボタンがクリックされるのクリックし、Youtube のプレイヤーがモーダル ポップアップとして表示されるのを確認してください。
    ...
    <img src="images/taskModule.png" width="300">
