...
* **Microsoft Teams 管理センターでサイドローディングの許可**
    ...
    具体的には [Microsoft Teams 管理センター](https://admin.teams.microsoft.com/)のメニュー[Teams のアプリ](https://admin.teams.microsoft.com/policies/app-setup/edit/) - \[グローバル (組織全体の既定値)\]-\[セットアップ ポリシー\] で 「カスタム アプリのアップロードを許可」をオンにします。
