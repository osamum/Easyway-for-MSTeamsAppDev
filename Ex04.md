...
8. ダイアログボックス\[**サンプルの JSON ペイロードを入力するか、貼り付けます。**\] が表示されるので、同ダイアログボックスのテキスト エリア部分に以下のサンプル JSON を貼り付け、\[完了\] ボタンをクリックします
 ...
 * 埋め込み Web ビュー
 ...
 <img src="images\21July_MsgExtn_ActionCtrl.png" width="300px">
